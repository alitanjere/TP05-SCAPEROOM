...
{
    private static string[] IncognitasSala { get; set; } = new string[] { "COMPLOT", "G99H72", "GDIPBEB", "7" };
    ...
    private static void ActualizarApoyo(TimeSpan tiempo)
{
    ...
    public static string GetDescripcion(int sala)
    {
        ...
        {
            case 1:
                return "Hay 5 jugadores en la casa. Eres el último en entrar y no conoces a nadie. Al principio te nominan y quedas en placa, pero te llaman al confesionario para demostrar por qué debes quedarte. Logras salir de placa.";
            case 2:
